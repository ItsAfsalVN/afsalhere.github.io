...
function Navbar({ isOpen, setIsOpen }) {
  return (
    <div className={` select-none fixed top-0 uppercase left-0 right-0 z-[200] w-screen pt-[32px] px-[24px] bg-primary text-secondary flex justify-center items-center transition-all duration-500 ease-in-out ${isOpen ? 'h-dvh opacity-100' : 'h-0 opacity-0'} overflow-hidden`}>
